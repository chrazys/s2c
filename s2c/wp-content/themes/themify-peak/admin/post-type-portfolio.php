...
if (!class_exists('Themify_Portfolio')) {
    ...
    class Themify_Portfolio {
        ...
        function shortcode($atts, $post_type) {
			...
			$style='custom_tiles'===$style?'auto_tiles':$style;
            ...
            if ($posts) {
                ...
                if (('yes' === $filter || $post_filter !== 'no') && $themify->post_layout!=='slider') {
                ...
                $out .= '</div>';
                $out = apply_filters( 'themify_get_shortcode_template', $out );
