				...
				<article class="post type-post tf_clearfix">
					...
					if ( ! themify_check( $key . '_hide_image' ) ) :?>
						<?php if ( themify_has_post_video() ) : ?>
							<figure class="post-video tf_clearfix">
								<?php  themify_post_video(); ?>
							</figure>
						<?php elseif( ( has_post_thumbnail() || themify_check( 'setting-auto_featured_image' ) ) && ($post_image = themify_get_image( $themify->auto_featured_image . 'setting=image_post_single&w=308&h=308' )) ) : ?>
							<figure class="post-image tf_clearfix">
									<a <?php themify_permalink_attr(); ?>><?php echo $post_image; ?><?php themify_zoom_icon(); ?></a>
							</figure>
						<?php endif; ?>
					<?php endif; ?>
