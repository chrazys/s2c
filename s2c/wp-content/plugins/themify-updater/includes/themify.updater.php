        ...
        public function upgrader_error_message($reply, $package , $upgrader) {
            ...
            if ( isset($upgrader->skin->plugin_info) ) {
                ...
                foreach ( $plugins as $plugin) {
                    ...
                    if ( isset( $temp['Name'], $upgrader->skin->plugin_info['Name'] ) && $temp['Name'] == $upgrader->skin->plugin_info['Name'] ) {
                        $name = dirname($plugin);
                        $nicename = $temp['Name'];
                    }
                }
                $version = isset( $upgrader->skin->plugin_info['Version'] ) ? $upgrader->skin->plugin_info['Version'] : null;
